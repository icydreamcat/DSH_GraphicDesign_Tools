...
const FACES = [
  ...
  {
    alias: 'SoukouMincho',
    file: 'SoukouMincho-2.ttf',
    label: 'Soukou Mincho — fine CJK Mincho, full CJK coverage',
    class: 'serif',
    scripts: ['hans', 'latn'],
    axes: null,
  },
  {
    alias: 'PuSong',
    file: 'ZhengQingKeNanBeiCiGongPuSongTi-2.ttf',
    label: 'KeNanBeiCi PuSong — classical CJK Song, fine strokes',
    class: 'serif',
    scripts: ['hans'],
    axes: null,
  },
  {
    alias: 'YuanQi',
    file: 'No.85-ShangShouYuanQiTi-2.ttf',
    label: 'ShangShou YuanQi — rounded CJK, contemporary poster weight',
    class: 'display',
    scripts: ['hans'],
    axes: null,
  },
  {
    alias: 'NovecentoLight',
    file: 'Novecento-wide-Light-2.ttf',
    label: 'Novecento Wide Light — wide Latin capitals, thin',
    class: 'grotesque',
    scripts: ['latn'],
    axes: null,
  },
  {
    alias: 'NovecentoMedium',
    file: 'Novecento-Wide-Medium-2.otf',
    label: 'Novecento Wide Medium — wide Latin capitals',
    class: 'grotesque',
    scripts: ['latn'],
    axes: null,
  },
  {
    alias: 'NovecentoBold',
    file: 'Novecento-Wide-Bold-2.otf',
    label: 'Novecento Wide Bold — wide Latin capitals, heavy',
    class: 'grotesque',
    scripts: ['latn'],
    axes: null,
  },
